          ...
          <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-y-2">
              ...
              <button
                ...
                className="inline-flex items-center px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm border border-transparent font-medium rounded-md shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 w-fit sm:w-auto"
              >
                Logout
              </button>
            </div>
